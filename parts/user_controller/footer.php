      ...
      <div class="d-flex flex-wrap justify-content-between">
        <div>
          ...
          <p class="my-3" style="width: 250px">
           Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellendus, vero nostrum dicta illum nihil quos quod praesentium quam laudantium voluptatibus qui fuga nisi fugiat in, aperiam sit. Voluptas, fuga officiis.
          </p>
        <!--   <span class="mt-4">
