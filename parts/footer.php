<div class=" mt-3" id="footer">
  ...
  <footer class="page-footer shadow">
    <div class="d-flex flex-column mx-auto py-5" style="width: 80%">
      <div class="d-flex flex-wrap justify-content-between">
        <div>
          ...
          <p class="my-3" style="width: 250px">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil cupiditate velit, dolore maxime voluptatum libero magnam optio laborum consequatur at debitis asperiores nemo cumque atque ipsum facere harum beatae nobis?
          </p>
        <!--   <span class="mt-4">
        ...
        <div>
          <p class="h5 mb-4" style="font-weight: 600">PAWFECT</p>
      ...
      <small class="text-center mt-5">&copy; PAWFECT, 2024. All rights reserved.</small>
    </div>
  </footer>
</div>